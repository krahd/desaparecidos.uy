...
- grayscale output by default for generated stills and videos, with an explicit **Colour output** option in each GUI generation panel and `colour_output` in the API (`--colour` in the CLI).
