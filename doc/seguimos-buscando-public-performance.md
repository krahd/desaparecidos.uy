...
**Protocol licence:** CC BY 4.0. Software licence: MIT. See `../LICENSE-PROTOCOL.md` and `../LICENSING.md`.
...
The intended memorial would therefore grow through acts of searching and the memorial manifestations people choose to contribute. Optional documentation could add another layer to that history without becoming obligatory.
...
6. **Optionally contribute the activation.** If participants choose to do so, the encounter sequence, generated manifestation and appropriate provenance can enter the planned public memorial after explicit consent, rights review and curatorial review. Publication is never automatic.
...
## Planned growing memorial

The planned public site should accumulate reviewed activation records that participants or groups choose to contribute over time. A visitor could therefore encounter both the disappeared and the continuing history of searches carried out in the present, even when no participant-facing documentation of those performances exists.
...
The project separates rights layers rather than treating "open" as one blanket permission:

- **software:** licensed under the MIT License; see `../LICENSE`;
- **public-performance protocol and future facilitator documentation explicitly marked as protocol material:** licensed under CC BY 4.0; see `../LICENSE-PROTOCOL.md`;
- **canonical disappeared-person records and source portraits:** retain their existing provenance and rights conditions; they are not relicensed merely because the code and protocol are open;
...
See `../LICENSING.md` for repository-wide scope. The method can therefore be reused publicly without turning sensitive historical or participant material into an unrestricted data commons.
...
The intended Arte Útil relation is the shift from spectator to user/performer. People would not merely see a memorial image: they would carry out a situated search, contribute the present-day material from which the image becomes possible, and could add the reviewed activation to a memorial available for later activation and reuse. Optional documentation of the performance could be added as a further layer without becoming a condition of participation.
